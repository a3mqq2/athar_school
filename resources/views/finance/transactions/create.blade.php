...
@section('title','إضافة معاملة مالية')
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="page-header">إضافة معاملة مالية</h3>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('finance.transactions.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="transaction-type-card card p-3 text-center" data-type="deposit">
                                ...
                                <div class="col-md-6">
                                    <div class="transaction-type-card card p-3 text-center" data-type="withdrawal">
                            ...
                            <input type="hidden" name="transaction_type" id="transaction_type" value="{{ old('transaction_type') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <select name="transaction_type_id" id="transaction_type_id" 
                                            class="form-select @error('transaction_type_id') is-invalid @enderror" required disabled>
                                        <option value="">اختر التصنيف</option>
                                    </select>
                                    <button type="button" class="btn btn-outline-primary" id="add-transaction-type-btn" 
                                            data-bs-toggle="modal" data-bs-target="#addTransactionTypeModal" disabled>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (transactionTypeInput.value) {
        const selectedCard = document.querySelector(`[data-type="${transactionTypeInput.value}"]`);
        if (selectedCard) {
            selectedCard.classList.add('selected');
            addTransactionTypeBtn.disabled = false;
        ...
        fetch(`{{ route('finance.api.transaction-types') }}?type=${type}`)
            ...
            .then(data => {
                ...
                data.forEach(transactionType => {
                    ...
                    if ('{{ old('transaction_type_id') }}' == transactionType.id) {
                        option.selected = true;
                    }
                    transactionTypeSelect.appendChild(option);
                });
