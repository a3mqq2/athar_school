...
<div class="container py-4">
    <h3 class="page-header">إضافة مستخدم جديد</h3>

    <form action="{{ route('admin.users.store') }}" method="POST" class="form-card" id="user-form">
        @csrf

        <div class="form-card-header">
            <h5 class="form-card-title"><i class="fa fa-user-plus"></i> البيانات الأساسية</h5>
        </div>
        ...
        <div class="form-card-body">
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    <label class="form-label"><span class="required">*</span> كلمة المرور</label>
                ...
                <div class="col-12">
                    <div class="role-section">
                        ...
                        <div class="permissions-container" id="roles-permissions-container">
                            @php 
                                $oldRoles = (array) old('role', []);
                                $oldPerms = (array) old('permissions', []);
                            @endphp
        ...
        <div class="form-card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6 teacher-only" style="display:none">
                    ...
                    <input type="number" step="0.01" min="0" name="session_price" id="session_price" class="form-control" value="{{ old('session_price') }}">
                </div>
                ...
                <div class="col-md-6 staff-only" style="display:none">
                    ...
                    <input type="number" step="0.01" min="0" name="salary" id="salary" class="form-control" value="{{ old('salary') }}">
                </div>
